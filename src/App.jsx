    ...
    <div id="top" className="min-h-dvh">
              ...
              <div className="lg:col-span-7">
                <Reveal>
                  ...
                  <h1 className="mt-5 text-balance text-5xl font-semibold tracking-tight sm:text-6xl lg:text-7xl">
                    ...
                    <span className="block bg-gradient-to-r from-fuchsia-500 via-violet-400 to-cyan-300 bg-clip-text text-transparent">
                ...
                <Reveal delay={0.05}>
                  <div className="glass relative overflow-hidden p-6">
                    <div className="pointer-events-none absolute inset-0">
                      <div className="absolute -right-28 -top-28 h-72 w-72 rounded-full bg-fuchsia-500/15 blur-3xl" />
                      <div className="absolute -bottom-28 -left-28 h-72 w-72 rounded-full bg-cyan-400/15 blur-3xl" />
                    </div>

                    <div className="relative">
                      <div className="chip w-fit">What I do</div>
                      <h2 className="mt-4 text-2xl font-semibold tracking-tight">
                        Craft. Motion. Systems.
                      </h2>
                      <p className="mt-2 text-sm text-white/70">
                        Clean architecture underneath. High-impact design on top.
                      ...
                      <div className="mt-5 grid gap-2">
                        {content.person.highlights.map((h) => (
                          ...
                          >
                            <span className="mt-1 h-2 w-2 rounded-full bg-gradient-to-r from-fuchsia-500 to-cyan-400" />
                            <span>{h}</span>
                          </div>
                        ))}
                      </div>
              ...
              <div className="glass p-6 lg:col-span-2">
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    <div className="chip w-fit">Frontend</div>
                    <p className="mt-3 text-sm text-white/70">
                      Dynamic, performant interfaces with React.js and Next.js.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    <div className="chip w-fit">Backend</div>
                    <p className="mt-3 text-sm text-white/70">
      ...
      {showTop ? (
        <button
          ...
          className="fixed bottom-5 right-5 z-50 rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-sm text-white shadow-glow backdrop-blur-xl transition hover:bg-white/15"
